...
def test_function_handler():
    ...
    try:
        ...
        print("✅ FunctionHandler initialized")
...
def test_config_validation():
    ...
    try:
        from backend.config import DATABASE_URL, GEMINI_API_KEY, MAX_FUNCTION_CALLS

        # Check DATABASE_URL
        if DATABASE_URL:
            print("✅ DATABASE_URL is set")
        else:
            print("⚠️  DATABASE_URL is empty (will fail when accessing DB)")
