...
from backend.config import GEMINI_API_KEY, GEMINI_CHAT_MODEL, USE_MOCK_LLM, USE_FUNCTION_CALLING
...
class GeminiLLMClient(LLMClient):
    ...
    def generate_answer(self, context: str, question: str, session_id: str = None) -> str:
        ...
        """
        logger.info(f"GeminiLLMClient generating answer for question: {question[:50]}...")
...
Answer:"""
        ...
        try:
            ...
            logger.error(
                f"Gemini API call failed: {error_type}: {str(e)}",
                exc_info=True
            )
