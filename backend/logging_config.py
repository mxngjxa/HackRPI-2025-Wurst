...
def setup_logging(
    ...
    root_logger.info(f"Logging configured: level={log_level}, file={log_file or 'None'}")


def get_logger_with_session(name: str, session_id: Optional[str] = None) -> logging.LoggerAdapter:
    """
