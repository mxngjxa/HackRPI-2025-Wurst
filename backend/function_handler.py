...
class FunctionHandler:
    ...
    def generate_answer(
        ...
        logger.info(f"Generating answer with function calling for question: {question[:50]}...")
        ...
        while iteration < max_iterations:
            ...
            logger.info(f"Iteration {iteration}: Processing {len(function_calls)} function call(s)")
            ...
            try:
                ...
                logger.error(f"Error sending function responses: {str(e)}", exc_info=True)
